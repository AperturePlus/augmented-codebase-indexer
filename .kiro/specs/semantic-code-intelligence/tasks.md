...
- [x] 5. Graph builder and indexing integration
  - [x] 5.1 Implement `GraphBuilder` in `src/aci/services/graph_builder.py`
  ...
  - [x] 5.2 Integrate GraphBuilder into IndexingService
  ...
  - [x] 5.3 Write unit tests for GraphBuilder
...
- [x] 7. Topology analyzer and PageRank scorer
  - [x] 7.1 Implement `TopologyAnalyzer` in `src/aci/services/topology_analyzer.py`
  ...
  - [x] 7.2 Implement `PageRankScorer` in `src/aci/services/pagerank_scorer.py`
  ...
  - [x] 7.3 Write unit tests for TopologyAnalyzer
  ...
  - [x] 7.4 Write unit tests for PageRankScorer
...
- [x] 8. RRF fuser and query router
  - [x] 8.1 Implement `RRFFuser` in `src/aci/services/rrf_fuser.py`
  ...
  - [x] 8.2 Implement `QueryRouter` in `src/aci/services/query_router.py`
...
- [x] 9. Context assembler
  - [x] 9.1 Implement `ContextAssembler` in `src/aci/services/context_assembler.py`
  ...
  - [x] 9.2 Write unit tests for ContextAssembler
...
- [x] 11. LLM enricher
  - [x] 11.1 Implement `LLMEnricher` in `src/aci/services/llm_enricher.py`
  ...
  - [x] 11.2 Write unit tests for LLMEnricher
...
- [x] 12. Graph-aware search integration
  - [x] 12.1 Update `SearchService` to support `include_graph_context` parameter
  ...
  - [x] 12.2 Write unit tests for graph-aware search
...
- [x] 13. Service container wiring
  - [x] 13.1 Update `ServicesContainer` and `create_services()` in `src/aci/services/container.py`
  ...
  - [x] 13.2 Update `MCPContext` and `create_mcp_context()` in `src/aci/mcp/context.py`
...
- [x] 15. MCP tool exposure
  - [x] 15.1 Add `get_symbol_context` and `query_graph` tool definitions to `src/aci/mcp/tools.py`
  ...
  - [x] 15.2 Implement MCP handlers for new tools in `src/aci/mcp/handlers.py`
...
- [x] 16. ACI library API
  - [x] 16.1 Implement `ACI` class in `src/aci/__init__.py`
...
- [x] 17. Docker deployment enhancements
  - [x] 17.1 Update Dockerfile and Docker configuration
